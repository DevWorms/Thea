...
/**
 * Created by sergio on 16/10/16.
 */

public class FragmentPosicion extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            status.startResolutionForResult(FragmentPosicion.this, PETICION_CONFIG_UBICACION);
    ...
    private void startLocationUpdates() {
        if (ActivityCompat.checkSelfPermission(FragmentPosicion.this,
            ...
            LocationServices.FusedLocationApi.requestLocationUpdates(
                    apiClient, locRequest, FragmentPosicion.this);
        }
    }
